package cn.szh.oauth.config;
import cn.szh.oauth.util.UserJwt;
import cn.szh.user.feign.UserFeign;
...
//                return new User(username,new BCryptPasswordEncoder().encode(clientSecret), AuthorityUtils.commaSeparatedStringToAuthorityList(""));
        ...
        Result<cn.szh.user.pojo.User> user = userFeign.findById(username);

        //根据用户名查询用户信息
//        String pwd = new BCryptPasswordEncoder().encode("szitheima");
        //创建User对象
        String permissions = "goods_list,seckill_list,admin,user";
