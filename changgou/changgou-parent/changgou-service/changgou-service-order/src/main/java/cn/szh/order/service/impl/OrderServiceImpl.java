...
import cn.szh.order.dao.OrderItemMapper;
import cn.szh.order.dao.OrderMapper;
import cn.szh.order.pojo.Order;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Order add(Order order) {
        ...
        orderItems = JSON.parseArray(orderItems.toString(), OrderItem.class);
