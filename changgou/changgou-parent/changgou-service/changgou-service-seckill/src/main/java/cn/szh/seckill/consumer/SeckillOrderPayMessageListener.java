package cn.szh.seckill.consumer;

import cn.szh.seckill.dao.SeckillGoodsMapper;
import cn.szh.seckill.dao.SeckillOrderMapper;

import cn.szh.seckill.feign.WeixinPayFeign;
import cn.szh.seckill.pojo.SeckillGoods;
import cn.szh.seckill.pojo.SeckillOrder;
import cn.szh.seckill.pojo.SeckillStatus;
import cn.szh.seckill.service.SeckillOrderService;
...
public class SeckillOrderPayMessageListener {
    ...
    public void consumeMessage(@Payload String msg) throws ParseException {
        System.out.println("消费端接收数据======="+ new Date());
        String nmsg = String.valueOf(msg);
        System.out.println(msg);

        //1.获取数据 json格式的字符串
        Map<String,String> allMap = JSON.parseObject(nmsg, Map.class);
//        Map<String,String> allMap = msg;
